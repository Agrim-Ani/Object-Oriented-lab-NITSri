...
class Bank_Account {
    ...
    void info_of_account_holder(int balance=1000)
    {
    ...
    void deposit_money(int alpha_beta=0, int gamma_sigma=1000)
    {
        int x,y;
    ...
    inline void check_amt_and_withdraw(int value_withdraw=0){
        int z;
    ...
    void Display_name_balance(float hold=1.001,int num=100){
